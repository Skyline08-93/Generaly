...
async def init_telegram():
    """Асинхронная инициализация Telegram бота"""
    global telegram_app, telegram_ready, telegram_error
    ...
    try:
        ...
        me = await test_bot.get_me()  # Проверка токена
        
        if not me:
            telegram_error = "Не удалось получить информацию о боте"
            return
